 ...
 * @fileoverview Component set ComponentGhotiFlier
 */
...
class ComponentGhotiFlier extends React.Component<IProps, IState> {
...
export default ComponentGhotiFlier;
